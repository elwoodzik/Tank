...
class Leya {
    ...
    constructor(width, height, orientation, scallable, mobile, preload, create) {
    ...
    preloaded() {
        AssetManager.load(this.preload(), this.loaded.bind(this), (loaded, total, key, path, success) => console.log(loaded, total, key, path, success));
    }
