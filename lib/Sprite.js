...
class Sprite extends _ObjectSettings {
    ...
    constructor(game, options) {
        ...
        this.states = {
            'static': {
                frames: [{ sx: 0, sy: 0, fW: this.width, fH: this.height }]
            }
        };
    ...
    draw(dt) {
        ...
        this.game.ctx.drawImage(
            ...
            this.body.angle === 0 ? this.renderX - (!this.static ? this.game.camera.xScroll : 0): -this.states[this.state].frames[this.current_f].fW * this.body.anchorX,
            this.body.angle === 0 ? this.renderY - (!this.static ? this.game.camera.yScroll : 0) : -this.states[this.state].frames[this.current_f].fH * this.body.anchorY,
